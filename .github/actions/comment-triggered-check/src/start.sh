...
finish_and_exit() {
  ...
  emit "dispatch-ref" "$dispatch_ref"
...
# Fork support is explicit. An association is not enough here: COLLABORATOR may
# be read-only, while running fork code with secrets requires maintainer approval.
