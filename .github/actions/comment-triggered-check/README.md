...
|     reason      | string |                                                                                                                                  Why the command will not run: <br>fork, insufficient-permission, empty-filter, malformed-filter, not-a-pull-request, pull-request-closed, <br>pull-request-unreadable, or check-run-not-created. Empty when it <br>will.                                                                                                                                   |
