...
| go-licenses-version | string |  false   |        `"v2.0.1"`         |                                    Version of go-licenses to install (e.g. v1.6.0, v1.0.0). <br>v1.0.0 does not support `--ignore` — <br>set `package-mode: go-work` when using it.                                     |
