...
# <repo>` and `gh release edit <tag> --repo <repo> --prerelease=false
# --latest`. Records every invocation (one line per call) into $GH_MOCK_CALLS.
#
...
# succeeds unless GH_MOCK_FAIL=1.
...
#!/usr/bin/env bash
# Mock gh. Only covers `gh release view` and `gh release edit`.
